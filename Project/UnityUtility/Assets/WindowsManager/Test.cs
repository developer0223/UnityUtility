...
public class Test : MonoBehaviour
{
    ...
    {
        SetFramelessWindow();
        MoveWindowPos(new Vector2(0, 0), 1920, 1040);
    }
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.X))
            MoveWindowPos(new Vector2(500, 500), 1920, 1040);
    ...
    {
        Screen.SetResolution(1920, 1040, false);
        MoveWindowPos(Vector2.zero, 1920, 1040);
        SetFramelessWindow();
    }
    ...
    public static void MoveWindowPos(Vector2 posDelta, int newWidth, int newHeight)
    {
        ...
        int x = (int)posDelta.x;
        int y = (int)posDelta.y;
